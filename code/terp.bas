...
IF SF% AND 2^15 IF IA%(9)<>-1 AND IA%(9)<>R% PRINT"I CAN'T SEE, ITS TOO DARK.":PROCv:B%=0:ENDPROC
...
REM 61. DEAD
DEFPROC830:PRINT"I'M DEAD...":R%=RL%:SF%=SF% AND NOT (2^15):PROCdRM:ENDPROC
...
DEFFNb:LOCALA%,C%,I%:VDU11:IF PAGE>&DFF ELSE VDU8:A%=&87:FORI%=1TO40:VDU9:C%=(USR(&FFF4)AND&FF00)DIV256:IFC%=32NEXT:VDU10,13:=TRUE ELSEI%=40:NEXT:VDU10,13:=FALSE
