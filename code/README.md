...
[***example.sh***](https://github.com/ahope1/BeebScott/blob/main/code/example.sh) **contains the list of commands used in the how-to video linked below.** The commands convert the TRS-80 .DAT game file for Scott Adams's first game Adventureland for use with BeebScott. They then add the converted file to *template.ssd*, together with the other files required. 
