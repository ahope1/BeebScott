...
REPEAT PROCb:INPUT"Tell me what to do? "TP$:PRINT:PROC170:REMP.NT$(0),NT$(1),NV(0),NV(1)
IF F PRINT Y$:UNTIL0
...
REMK$="":FORZ=0TOIL:IF K IF IA(Z)=R PROCb:PRINT"VISIBLE ITEMS HERE:":K=0
...
IF A<52 IF A PROCp(MS$(A)):IF NOT W% IF POS P.
...
IF A>101 PROCp(MS$(A-50)):IF NOT W% IF POS P.
...
REM 66. INV
DEFPROC890:PRINT"I'M CARRYING:":W=TRUE:FORZ=0TOIL:IFIA(Z)=-1 W=FALSE:PROC280:PROCo(TP$+". ")
NEXT:IF W PRINT"Nothing"
