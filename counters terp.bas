...
REM40 cont=0:K=0:Z$="I'VE TOO MUCH TOO CARRY. TRY -TAKE INVENTORY-":GOSUB1240:GOTO100
40 DIM CT(8):CT=0:cont=0:K=0:Z$="I'VE TOO MUCH TOO CARRY. TRY -TAKE INVENTORY-":GOSUB1240:GOTO100
...
120 d=OPENIN("SAV"):INPUT#d,SF,R,CT:FORX=0TOIL:INPUT#d,IA(X):NEXT:FORX=0TO8:INPUT#d,CT(X):NEXT:CLOSE#d:IFD<>-1CLOSE
...
150 GOSUB360:IF LT<0 ELSE IFIA(9)=0 ELSE CT(8)=CT(8)-1:IFCT(8)=0THEN SF=SF OR 2^16:PRINT"LIGHT HAS RUN OUT"ELSEIFCT(8) IFCT(8)<25PRINT"LIGHT RUNS OUT IN ";CT(8);" TURN"CHR$(ASC("S")*-(CT(8)>1))"!"
...
400 F2=-1:F=0:F3=-1:FORY=1TO5:W=CA(X,Y):LL=INT(W/20):K=W-LL*20:F1=-1:ON K+1 GOTO550,430,450,470,490,500,510,520,530,540,410,420,440,460,480,542,543,0,0,544
...
590 IF AC>101 THEN600 ELSE IFAC=0 THEN960 ELSE IFAC<52 THEN PROCp(MS$(AC)):GOTO960:ELSE ON AC-51 GOTO660,700,740,760,770,780,790,760,810,830,840,850,860,870,890,920,930,940,950,710,750,955,0,0,0,942,943,944,0,945,946,947
...
720 d=OPENOUT("SAV"):PRINT#d,SF,R,CT:FORW=0TOIL:PRINT#d,IA(W):NEXT:FORW=0TO8:PRINT#d,CT(W):NEXT:CLOSE#d:IFD<>-1CLOSE
730 GOTO960
