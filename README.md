...
***terp.bas*** is BeebScott, the BBC BASIC interpreter program. It reads in a game data file and lets the user play the game on a BBC Micro computer or emulator.
